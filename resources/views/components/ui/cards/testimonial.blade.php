<div class="bg-white rounded-xl w-fit flex flex-col items-center text-center p-8 gap-5">
    ...
    <p class="text-base-black">
        Satu Atap Akademik sangat memudahkan saya dalam mengakses semua materi kuliah dan tugas. Semuanya
        terorganisir dengan baik dalam satu platform. Sangat direkomendasikan!
    </p>
